...
public class GmjInformacionPacienteDTO implements java.io.Serializable {
	private String esDerechoHabiente;
	 ...
	 */
	public String getEsDerechoHabiente() {
		return esDerechoHabiente;
	}
	/**
	 * @param esDerechoHabiente the esDerechoHabiente to set
	 */
	public void setEsDerechoHabiente(String esDerechoHabiente) {
	...
	/**
	 * @return the derechoHabiencia
	 */
	public String getDerechoHabiencia() {
		return derechoHabiencia;
	}
	/**
	 * @param derechoHabiencia the derechoHabiencia to set
	 */
