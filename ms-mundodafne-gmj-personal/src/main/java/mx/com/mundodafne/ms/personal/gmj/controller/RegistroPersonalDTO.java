...
public class RegistroPersonalDTO {
	...
	/**
	 * @return the cedulaProfEspe
	 */
	public String getCedulaProfEspe() {
		return cedulaProfEspe;
	}
	/**
	 * @param cedulaProfEspe the cedulaProfEspe to set
	 */
	public void setCedulaProfEspe(String cedulaProfEspe) {
